...
#define STRING_CONFIG_H_AUTHOR "(Thorsten Gilfert HEVO SKR 1.3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HEVO SKR 1.3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.8, 80.5, 401, 86 }
